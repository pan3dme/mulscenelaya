...
var SkillDandaoPanel = /** @class */ (function (_super) {
    ...
    SkillDandaoPanel.prototype.loadSkill = function () {
        this.layaSceneLevel.scene.skillManager.preLoadSkill(getSkillUrl("400020"));
    };
    ...
    SkillDandaoPanel.prototype.playDindianSkill = function ($char) {
        ...
        var $skill = this.layaSceneLevel.scene.skillManager.getSkill(getSkillUrl("400020"), "skill_01");
        // $skill.actionEnd=true
        console.log("$skill.keyAry", $skill.keyAry);
        //if (!$skill.keyAry) {
        //    return;
        //}
        if ($skill) {
