...
(function (topfront) {
    ...
    var LayaForntPanel = /** @class */ (function (_super) {
        ...
        function LayaForntPanel() {
            ...
            _this._baseRender.uiAtlas.loadImgUrl("ui/textlist/textlistabc.png", function () { _this.loadConfigCom(); });
            return _this;
        }
        ...
        LayaForntPanel.prototype.drawDynamicTextDemo = function () {
        ...
        LayaForntPanel.prototype.addB = function (v2d) {
            ...
            b.width = 320;
            b.height = 80;
            var c = this.drawLabel(2, "fanji", false);
            c.x = b.x + 10;
            c.y = b.y + 30;
            var d = this.drawLabel(1, { color: "yellow", num: 8888 }, false);
            d.x = b.x + 100;
            d.y = b.y + 30;
            d.alpha = 1;
        };
        ...
        LayaForntPanel.prototype.numStrVo = function (color, num, isbottom) {
